...
> 用户主要维护 `background/story-background.md`、`bible/characters/*.md` 与 `harness/*.json` 三个创作输入板块；其余故事骨架、场次大纲和台账由 Skill 根据输入生成或维护。
...
- 序列：`outline/sequence-outline.md`
- 逐场大纲：`outline/scene-outline.md`
- Harness 状态库：`harness/`
- 正文：`screenplay/scenes/`
- 台账：`ledger/story-ledger.json`
- 自审：`reviews/`
- 导出：`exports/`
